# Superstore Sales Performance Analysis (2011-2014)
...
* **report.pdf**  
Executive-style summary of findings, business context, and
recommendations
* **workbook.xlsx**  
Excel-based analysis using pivot tables, calculated metrics, and
interactive slicers
* **dashboard.png**  
Static view of the dashboard summarizing profitability drivers
across four analytical views

\---

## Data \& Method

Analysis is based on a retail transaction dataset (\~10,000 records,
2011-2014) including sales, profit, discount, product hierarchy,
region, and customer segment data.  
The analysis was performed in Excel using pivot tables and calculated
metrics such as profit margin, sales share, and discount tiers.
